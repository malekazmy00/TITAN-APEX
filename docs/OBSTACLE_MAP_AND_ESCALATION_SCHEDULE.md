...
10، test-environment/CHANGELOG.md) — العنصر الخامس الوحيد الناقص من
السيناريو ده هو **Shadow DOM**، وده بالظبط الخطوة الجاية (محور 3،
مسجّلة كـ "فجوة" تحت) بمجرد ما الجولة دي تتأكد بدليل CI.
